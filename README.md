...
**[POST] https://apigateway.serpro.gov.br/datavalid-trial/biometria/vbeta1/validate/pf-face**: chamamos a url do serviço de validação de PF com biometria de face do Datavalid passando como argumento -d, o corpo da requisiço REST."
...
([Download direto do arquivo](https://rawgit.com/devserpro/datavalid-biometria/master/_layouts/DadosPessoasFisicasBiometria.csv)) 
